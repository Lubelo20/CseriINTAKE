  ...
  return (
    <div className="w-full">
          ...
          return (
            <div key={key} className="flex flex-col items-center flex-1">
              <div className={cn(
                ...
                isComplete && 'bg-cseri-green text-white',
                isCurrent && 'bg-cseri-dark text-white ring-2 ring-cseri-green ring-offset-2',
              ...
              <span className={cn(
                ...
                isCurrent ? 'text-cseri-dark font-semibold' : 'text-gray-400',
              )}>
                {t(key)}
              </span>
            </div>
      ...
      <div className="w-full bg-gray-200 rounded-full h-1.5">
        <div
          className="bg-cseri-green h-1.5 rounded-full transition-all duration-300"
